...
namespace CadeMeuMedico.API.Controllers
{
    ...
    public class UsuariosController : Controller
    {
        ...
        [HttpGet]
        public bool SenhaEstaCorreta(string login, string senha)
        {
            //pass criptografado
           var usuario =  _context.Usuarios.FirstOrDefault(x => x.Login == login && x.Senha == senha);

            if (usuario != null)
            {
                //gravar na sessao usuario
                //levar token autenticacao
